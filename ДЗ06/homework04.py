...
car_1 = Car('белый', 'Toyota Camry', False)
test_drive(car_1)

car_2 = TownCar('серый', 'Volkswagen Polo')
test_drive(car_2)

car_3 = SportCar('красный', 'Ferrari 488 GTB')
test_drive(car_3)

car_4 = WorkCar('черный', 'Reno Logan')
test_drive(car_4)

car_5 = PoliceCar('синий', 'Ford Mondeo')
test_drive(car_5)